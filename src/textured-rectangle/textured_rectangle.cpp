...
void TexturedRectangle::setUpPipelines() {
	...
	std::vector<vk::PipelineShaderStageCreateInfo> shaderStages = module
		.loadShader("data/rec-vert.spv", vk::ShaderStageFlagBits::eVertex)
		.loadShader("data/rec-frag.spv", vk::ShaderStageFlagBits::eFragment).shaderStages();
...
std::vector<ao::vulkan::DrawInCommandBuffer> TexturedRectangle::updateSecondaryCommandBuffers() {
