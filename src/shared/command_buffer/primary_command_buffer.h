...
namespace ao::vulkan {
    ...
    /**
     * @brief Primary command buffer implementation.
     *
     ...
     *
     */
    class PrimaryCommandBuffer : public CommandBuffer<vk::RenderPass, vk::Framebuffer, vk::Extent2D, int> {
       public:
        /**
         * @brief Construct a new PrimaryCommandBuffer object
         *
         * @param command_buffer Command buffer
         * @param policy Execution policy for command buffer update (secondary)
         * @param update_code Update code applied to command buffer
         * @param inheritance_create Code to create a vk::CommandBufferInheritanceInfo
         */
        ...
        /**
         * @brief Destroy the PrimaryCommandBuffer object
         *
         */
